 ...
 */
 app.config(['$stateProvider', '$urlRouterProvider', '$controllerProvider', '$compileProvider', '$filterProvider', '$provide', '$ocLazyLoadProvider', 'JS_REQUIRES',
    ...
    splittedUrl.shift();
    var routeUrl = '/' + splittedUrl.join('/');


    console.log(routeUrl);

    $urlRouterProvider.when(routeUrl, [ '$stateParams', '$state', function ( $stateParams, $state) {
        console.log($stateParams);
        console.log($state);
        if ($state.current.views === null && $state.current.url === '^' && $state.current.abstract && $state.current.name === '') {
    ...
    .state('app.contacts.list', {
        url: "/list",
        templateUrl: "assets/views/contacts/contacts.html",
        title: 'Contacts',
    ...
    .state('app.contacts.person', {
        url: "/{params:params}",
        templateUrl: "assets/views/contacts/contact_info.html",
