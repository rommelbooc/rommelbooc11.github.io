...
function ($rootScope, $state, $stateParams) {
    ...
    $rootScope.app = {
        ...
        defaultLayout: {
            ...
            logo: 'assets/images/branding.svg', // relative path of the project logo
...
app.config(function ($breadcrumbProvider) {
    $breadcrumbProvider.setOptions({
        template: '<ul class="breadcrumb"><li><a ui-sref="app.contacts.list" class="breadcrumb-root"><img ng-src="assets/images/crm_icons_svg/contacts_cyan.svg">Contacts</a></li><li ng-repeat="step in steps">{{step.ncyBreadcrumbLabel}}</li></ul>'
    });
});
// ng-storage
...
app.config(['$urlMatcherFactoryProvider', function($urlMatcherFactory) {
  $urlMatcherFactory.type('params',
{
 name : 'params',
 decode: function(val) { return typeof(val) === "string" ? JSON.parse(val) : val; },
 encode: function(val) { return val.id; },
 is: function(val) { return angular.isObject(val) && "firstname" in val && "lastname" in val && "id" in val },
})
}]);
